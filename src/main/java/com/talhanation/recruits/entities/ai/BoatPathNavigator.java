...
import com.talhanation.recruits.entities.BoatNodeEvaluator;
...
public class BoatPathNavigator extends PathNavigation {

    public BoatPathNavigator(Mob entitylivingIn, Level worldIn) {
